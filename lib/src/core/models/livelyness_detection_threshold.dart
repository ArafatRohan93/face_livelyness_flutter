...
abstract class LivelynessDetectionThreshold extends Equatable {
  const LivelynessDetectionThreshold();
  LivelynessDetectionThreshold fromDict(Map<String, dynamic> map);
...
class SmileDetectionThreshold extends LivelynessDetectionThreshold {
...
class BlinkDetectionThreshold extends LivelynessDetectionThreshold {
...
class HeadTurnDetectionThreshold extends LivelynessDetectionThreshold {
